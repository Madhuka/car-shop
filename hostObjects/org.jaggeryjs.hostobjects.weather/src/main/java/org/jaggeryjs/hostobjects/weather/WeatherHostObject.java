...
public class WeatherHostObject extends ScriptableObject {
	...
	public static String report(Context cx, Scriptable thisObj, Object[] args,
		...
		if (argsCount == 2) {
			...
			return cityName + " Weather Report for RaceTrack No, "
					+ raceTrackNo + ": " + weatherHostObject.getWeather();
		}
	...
	public String getWeather() {
		String[] weatherConditionList = { "Fair", " Clear", " Fair with Haze",
				" Mostly Cloudy ", " Fair and Breezy", " Clear and Breezy",
				" Partly Cloudy", "Partial Fog" };
